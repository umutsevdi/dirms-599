...
from app.api import auth, entity, employees, archetypes, inventory, incidents, people_reports, needs_archetypes
...
app.include_router(people_reports.router, prefix="/api")
app.include_router(needs_archetypes.router, prefix="/api")
